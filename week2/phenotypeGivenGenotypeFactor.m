...
for i = 1:2:length(assignments)
  if (assignments(i,2)==1)
    phenotypeFactor.val(i) = alphaList(1);
  elseif (assignments(i,2)==2)
    phenotypeFactor.val(i) = alphaList(2);
  elseif (assignments(i,2)==3)
    phenotypeFactor.val(i) = alphaList(3);
  endif  
endfor
for i = 2:2:length(assignments)
  phenotypeFactor.val(i) = 1-phenotypeFactor.val(i-1);
endfor
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%